...
/* ─────────────────────────────────────────────────────────────────────────
   Hardcoded demo location — stand-in for the estate/property until real
   geofence data (drawn in the Geofence screen) is wired through.
   Lekki Phase 1, Lagos.
   ──────────────────────────────────────────────────────────────────────── */
const ESTATE_CENTER: [number, number] = [3.4732, 6.4392]; // [lng, lat]
const GEOFENCE_RADIUS_KM = 0.35;

/** Roughly-accurate circle polygon around a center point — good enough for a
 *  demo geofence boundary at neighborhood scale (not for precise surveying). */
...
/* ─── Vehicle marker (small tracked car) ───────────────────────────────── */
...
/* ─── "A" location pin (geofence center) ───────────────────────────────── */
...
export function LiveMapCard() {
  // Small offset so the vehicle marker doesn't sit exactly on the pin.
